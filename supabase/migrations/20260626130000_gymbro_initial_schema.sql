...
insert into public.gymbro_machines (id, name, note, sort_order) values
  ...
  ('standard-standing-calf-raise', 'Подъем на икры стоя', 'Standing calf raise machine. Подъем на носки стоя с упором в наклонную платформу.', 75),
  ('standard-glute-kickback', 'Отведение ноги назад', 'Glute kickback. Нога уходит назад, акцент на ягодицы.', 80),
  ('standard-barbell-hip-thrust', 'Ягодичный мост со штангой', 'Barbell hip thrust. Ягодичный мост со штангой на тазу и плечами на скамье.', 85),
  ('standard-barbell-romanian-deadlift', 'Румынская тяга', 'Barbell Romanian deadlift. Наклон со штангой у ног, таз назад и слегка согнутые колени.', 87),
  ('standard-bulgarian-split-squat', 'Болгарские приседания', 'Bulgarian split squat. Выпад с задней стопой на скамье.', 88),
  ('standard-dumbbell-lunges', 'Выпады с гантелями', 'Dumbbell lunges. Выпад вперед с гантелями в руках по бокам.', 89),
  ...
  ('standard-downward-pec-fly', 'Сведение рук вниз', 'Downward pec fly. Рычажное сведение рук по дуге вниз к корпусу.', 125),
  ...
  ('standard-assisted-pull-up-dip', 'Подтягивания', 'Assisted pull-up / dip. Подтягивания или отжимания с противовесом.', 210)
