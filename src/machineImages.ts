...
const machineImagesById: Partial<Record<string, ImageSourcePropType>> = {
  ...
  'standard-curtsy-reverse-lunge': require('../assets/machines/curtsy-reverse-lunge.png'),
  'standard-downward-pec-fly': require('../assets/machines/downward-pec-fly.png'),
  ...
  'standard-elliptical': require('../assets/machines/elliptical.png'),
  ...
  'standard-stair-climber': require('../assets/machines/stair-climber.png'),
  'standard-treadmill': require('../assets/machines/treadmill.png'),
};
